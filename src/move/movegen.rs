...
pub fn generate_moves(position: &Position, side: usize)  {
        ...
        if side == Side::WHITE {
            if piece == Piece::WhitePawn as usize {
                ...
                while bitboard.0 != 0 {
                    ...
                    if !(target_square < Square::A8 as usize) && (position.occupancies[Side::BOTH as usize].get(target_square) == 0) {
                        // pawn promotion
                        if source_square >= Square::A7 as usize && source_square <= Square::H7 as usize {
                            ...
                            if (source_square >= Square::A2 as usize && source_square <= Square::H2 as usize) && (position.occupancies[Side::BOTH as usize].get(target_square - 8) == 0) {
        ...
        // generate black moves
            ...
            if piece == Piece::BlackPawn as usize {
                ...
                while bitboard.0 != 0 {
                    ...
                    // generate quiet pawn moves
                    if !(target_square > Square::H1 as usize) && (position.occupancies[Side::BOTH as usize].get(target_square) == 0) {
                        // pawn promotion
                        if source_square >= Square::A2 as usize && source_square <= Square::H2 as usize {
                            ...
                            // two squares ahead pawn move
                            if (source_square >= Square::A7 as usize && source_square <= Square::H7 as usize) && (position.occupancies[Side::BOTH as usize].get(target_square + 8) == 0) {
